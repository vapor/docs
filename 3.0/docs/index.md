...
!!! warning
	If you are starting a new project, you may want to consider using the Vapor 4 release candidates. Check out the docs for more information: [Vapor 4.0 docs &rarr;](https://docs.vapor.codes/4.0/)
