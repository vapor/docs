...
let languages: [Language] = [
    ...
    Language(
        .custom(code: "pt", name: "Português Brasileiro"),
        ...
        localisation: .init(
            ...
            tableOfContentsTitle: "Nesta página",
            previousPage: "Anterior",
            nextPage: "Próxima",
            editPage: "Editar esta página",
            fallbackTitle: "Tradução não disponível",
            fallbackMessage: "Esta página ainda não foi traduzida, portanto o idioma padrão é exibido.",
            notFoundTitle: "Página não encontrada",
            notFoundMessage: "A página que você está procurando pode ter sido movida, renomeada ou talvez nunca tenha existido.",
            notFoundLink: "Voltar para a página inicial",
            toggleNavigation: "Alternar navegação",
            toggleColourScheme: "Alternar esquema de cores"
        )
    ),
