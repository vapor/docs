...
let languages: [Language] = [
    ...
    Language(
        ...
        customStrings: [
            ...
            "footer.tagline": "Vapor bietet eine sichere, performante und einfach zu nutzende Grundlage, um HTTP-Server, Backends und APIs in Swift zu erstellen",
            ...
            "footer.frameworkDocs": "Framework-Doku",
            "apiDocs": "API-Doku",
    ...
    Language(
        ...
        customStrings: [
            ...
            "footer.tagline": "Vapor ofrece una base segura, eficiente y fácil de usar para crear servidores HTTP, backends y APIs en Swift",
    ...
    Language(
        ...
        customStrings: [
            ...
            "footer.tagline": "Vaporは、SwiftでHTTPサーバー、バックエンド、APIを構築するための、安全で高性能、かつ使いやすい基盤を提供します",
            "joinDiscord": "Discordに参加",
            "footer.joinDiscord": "Discordに参加",
            "supporters": "サポーター",
    ...
    Language(
        ...
        customStrings: [
            ...
            "footer.tagline": "Vapor는 Swift로 HTTP 서버, 백엔드, API를 구축하기 위한 안전하고 빠르며 사용하기 쉬운 기반을 제공합니다",
            "joinDiscord": "Discord 참여하기",
            "footer.joinDiscord": "Discord 참여하기",
            "supporters": "후원자",
    ...
    Language(
        ...
        customStrings: [
            ...
            "footer.tagline": "Vapor zapewnia bezpieczną, wydajną i łatwą w użyciu podstawę do budowania serwerów HTTP, backendów i API w Swift",
    ...
    Language(
        ...
        customStrings: [
            ...
            "footer.tagline": "Vapor 提供安全、高性能且易于使用的基础框架，助您用 Swift 构建 HTTP 服务器、后端和 API",
    ...
    // Arabic (RTL). `.arabic` sets isRTL automatically (see Kiln's LanguageCode).
    // Translations are a first pass — flag for native-speaker review before publish.
    Language(
        .arabic,
        siteName: "توثيق Vapor",
        description: "توثيق Vapor، إطار عمل الويب بلغة Swift.",
        navTranslations: [
            "APNS": "APNS",
            "Advanced": "متقدّم",
            "Async": "غير متزامن",
            ...
            "Validation": "التحقق",
            "Version (4.0)": "الإصدار (4.0)",
            "WebSockets": "WebSockets",
            "Welcome": "مرحبًا",
            "Xcode": "Xcode",
        ],
        customStrings: [
            "tagline": "يوفّر Vapor أساسًا آمنًا وعالي الأداء وسهل الاستخدام لبناء خوادم HTTP والخدمات الخلفية وواجهات API بلغة Swift",
            ...
            "frameworkDocs": "توثيق إطار العمل",
            "footer.frameworkDocs": "توثيق إطار العمل",
            "apiDocs": "توثيق API",
            "footer.apiDocs": "توثيق API",
            "frameworkDocsCaption": "تعلّم كيفية استخدام Vapor",
            "apiDocsCaption": "التوثيق المرجعي لـ Vapor",
            "selectLanguage": "اختر اللغة",
            "selectVersion": "اختر إصدار التوثيق",
            "selectTheme": "اختر المظهر",
            "closeMenu": "إغلاق القائمة",
            "skipToContent": "تخطَّ إلى المحتوى",
        ],
        image: "assets/og/ar-2x.png",
        localisation: .init(
            ...
            fallbackTitle: "الترجمة غير متوفّرة",
            fallbackMessage: "لم تُترجَم هذه الصفحة بعد، لذا تُعرَض باللغة الافتراضية.",
            notFoundTitle: "الصفحة غير موجودة",
            notFoundMessage: "ربما نُقلت الصفحة التي تبحث عنها أو أُعيدت تسميتها أو لم تكن موجودة أصلًا.",
            notFoundLink: "العودة إلى الصفحة الرئيسية",
            toggleNavigation: "تبديل التنقل",
            toggleColourScheme: "تبديل نظام الألوان",
            home: "الرئيسية",
            store: "المتجر",
            blog: "المدونة",
