...
Embora a aplicação mais útil de cookies seja através das [sessões](../advanced/sessions.md#configuração) integradas, você também pode acessar cookies diretamente via `Request.cookies`.
