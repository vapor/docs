...
!!! warning "Aviso"
    Para que o Leaf consiga encontrar os templates ao executar a partir do Xcode, você deve configurar o [diretório de trabalho personalizado](../getting-started/xcode.md#diretório-de-trabalho-personalizado) no seu workspace do Xcode.
