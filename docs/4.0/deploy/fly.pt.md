...
Primeiro, certifique-se de ter instalado o Vapor toolbox (veja as instruções de instalação para [macOS](../install/macos.md#instalar-o-toolbox) ou [Linux](../install/linux.md#instalar-o-toolbox)).
