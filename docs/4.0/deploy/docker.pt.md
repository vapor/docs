...
1. Instale ou compile o Vapor Toolbox ([macOS](../install/macos.md#instalar-o-toolbox), [Linux](../install/linux.md#instalar-o-toolbox)).
...
para obter logging no nível `trace` (o mais granular). Você pode usar essa variável de ambiente para definir o logging em [qualquer nível disponível](../basics/logging.md#nível).
