...
!!! tip
    Vous pouvez aussi récupérer le dernier modèle depuis GitHub sans passer par la Toolbox Vapor en clonant le [dépôt du modèle](https://github.com/vapor/template-bare)
