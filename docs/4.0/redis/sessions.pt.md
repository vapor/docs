...
O Redis pode atuar como um provedor de armazenamento para fazer cache de [dados de sessão](../advanced/sessions.md#dados-de-sessão), como credenciais de usuário.
